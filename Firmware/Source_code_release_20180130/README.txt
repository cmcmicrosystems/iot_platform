...
2. Stack project holds only the BLE stack configuration. More details can be found in TI the website
3. App project is based on TI example of "SimpleBroadCaster"
4. Each sensor has driver files *.h & *.c available in BSP_Drivers folder
		...
		si705x.h	--	Temperature sensor driver header
		si705x.c	--	Temperature sensor driver source
