...
const PIN_Config BoardGpioInitTable[] = {
    ...
    Board_ADX_INT1 | PIN_INPUT_EN | PIN_PULLUP ,
    Board_ADX_INT2 | PIN_INPUT_EN | PIN_PULLUP ,
    Board_OPT3001_INT | PIN_INPUT_EN | PIN_PULLUP ,
...
//    Board_BTN2   | PIN_INPUT_EN | PIN_PULLUP | PIN_IRQ_BOTHEDGES | PIN_HYSTERESIS,            /* Button is active low          */
    Board_SPI_ADX_CS | PIN_GPIO_OUTPUT_EN | PIN_GPIO_HIGH | PIN_PUSHPULL | PIN_DRVSTR_MAX,  /* External flash chip select    */
